...
We already know that rows 1, 2, 3 will be collapsed into one. Let's see the default behaviour of function:
...
- order of rows and columns was keeped, **however, it is important to note that for `cols_dedupe` first element of names passed to it will be used as a base for new names of columns and to determine the place for these columns**
